...
func NewClient(baseURL, clientID, clientSecret string) *Client {
	return NewClientWithUserAgent(baseURL, clientID, clientSecret, "jamfprotect-go-sdk/dev")
}

// NewClientWithUserAgent creates a new Jamf Protect GraphQL client with a custom user agent string.
